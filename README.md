...
```bash
curl -sSL https://raw.githubusercontent.com/slavamirniy/telegram_filestorage/refs/heads/main/telegram_filestorage.sh | tr -d '\r' > setup.sh && chmod +x setup.sh && sudo ./setup.sh
```
